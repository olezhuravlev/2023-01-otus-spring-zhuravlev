...
public class CLICommands {
    ...
    public String findBooksByTitle(String title) {
        List<Book> books = facade.findBooks(title);
        return bookPrinter.print(books);
    }
    ...
    public String addBook() {
        ...
        var existingAuthor = facade.getAuthor(authorId);
        ...
        var existingGenre = facade.getGenre(genreId);
        if (existingGenre.isEmpty()) {
            return messageSource.getMessage(NO_SUCH_GENRE, null, appProps.locale());
        }

        Book createdBook = facade.save(new Book(0L, title, existingAuthor.get(), existingGenre.get(), new ArrayList<>()));
    ...
    public String updateBook(long id) {
        ...
        var existingBook = facade.getBook(id);
        ...
        Book savedBook = facade.save(book);
    ...
    public String deleteBook(long id) {
        ...
        facade.deleteBook(existingBook.get());

        existingBook = facade.getBook(id);
    ...
    public String listBookComments(long bookId) {
        ...
        var existingBook = facade.getBook(bookId);
        if (existingBook.isEmpty()) {
            return messageSource.getMessage(NO_SUCH_BOOK, null, appProps.locale());
        }

        var bookComments = facade.getBookComments(existingBook.get());
    ...
    public String listBookComment(long bookId) {
        ...
        var existingBookComment = facade.getBookComment(existingBook.get(), commentId);
    ...
    public String addBookComment(long bookId) {
        ...
        facade.createBookComment(book, commentText);
    ...
    public String updateBookComment(long bookId) {
        ...
        String welcomeText = messageSource.getMessage(ENTER_BOOK_COMMENT_ID, null, appProps.locale());
        long commentId = Long.parseLong(cliValueProvider.getValue(welcomeText));
        var existingBookComment = facade.getBookComment(book, commentId);
        ...
        int result = facade.updateBookComment(bookComment, commentText);
    ...
    public String deleteBookComment(long bookId) {
        ...
        int result = facade.deleteBookComment(bookComment);
    ...
    public String deleteAllBookComments(long bookId) {
        ...
        int result = facade.deleteBookComments(book);
        return messageSource.getMessage(ROWS_DELETED, new String[]{String.valueOf(result)}, appProps.locale());
    }
}
